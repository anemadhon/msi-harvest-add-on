                ...
                <?php endif; ?>
                    <div class="card">
                        <div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-search4 mr-2"></i>Search of Sentul Entry Out</legend>  
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-list mr-2"></i>List of Sentul Entry Out</legend>
                            <a href="<?php echo site_url('transaksi1/sentulentry_out/add') ?>" class="btn btn-primary"> Add New</a>
                        </div>
                        <div class="card-body">
                            <div class="row">
        ...
        <script>
            ...
            function showListData(){
                ...
                dataTable = $('#tableWhole').DataTable({
                    ...
                    "ajax": {
                        "url":"<?php echo site_url('transaksi1/sentulentry_out/showListData');?>",
                        "type":"POST",
                    ...
                    "columns": [
                        {"data":"id_sentul_entry_header", "className":"text-center", render:function(data, type, row, meta){
                            rr = `<a href='<?php echo site_url('transaksi1/sentulentry_out/edit/')?>${data}' ><i class='icon-file-plus2' title="Edit"></i></a>`;
                            return rr;
                        }},
