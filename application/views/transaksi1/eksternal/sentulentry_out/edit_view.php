		...
		<script>
			$(document).ready(function(){
				...
				table = $("#tblWhole").DataTable({
					...
					"paging":false,
					"ajax": {
							"url":"<?php echo site_url('transaksi1/sentulentry_out/showDataDetailOnEdit');?>",
			...
			function addDatadb(id_approve){
				...
				setTimeout(() => {
					$.post("<?php echo site_url('transaksi1/sentulentry_out/addDataUpdate')?>", {
			...
			function onCancel() {
				...
				setTimeout(() => {
					$.post("<?php echo site_url('transaksi1/sentulentry_out/cancelDocument')?>", {
