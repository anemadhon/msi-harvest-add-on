...
<html lang="en">
	...
	<?php  $this->load->view("_template/nav.php")?>
									...
									<div class="col-md-12">
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" id="idSentulEntry" name="idSentulEntry" placeholder="ID Transaksi" readOnly>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<select class="form-control form-control-select2" id="typeDoc" name="typeDoc" data-live-search="true">
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<select class="form-control form-control-select2" id="reason" name="reason" data-live-search="true">
														...
														<option value="Receive from Vendor">Receive from Vendor</option>
														<option value="Receive from Production">Receive from Production</option>
														<option value="Send to Outlet">Send to Outlet</option>
														<option value="Send to Production">Send to Production</option>
													</select>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" id="fromOutlet" name="fromOutlet" value = "<?php echo $plant.' - '.$plant_name ?>" readOnly>
												</div>
											</div>
											...
											<div class="form-group row" hidden>
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" id="storageLocation" name="storageLocation" value = "<?php echo $storage_location.' - '.$storage_location_name ?>" readOnly>
												</div>
											</div>
											...
											<div class="form-group row" hidden>
												...
												<div class="col-lg-9">
													<select class="form-control form-control-select2" id="toOutlet" name="toOutlet" data-live-search="true">
														<option value="-">Select Warehouse</option>
														<?php 
														if(is_array($plant_user['MSI'])) {
															foreach($plant_user['MSI'] as $value):
															?>
		...
		function addDatadb(id_approve = ''){
			...
			// const temp_from_outlet = $('#fromOutlet').val().split(' (');
			// const from_outlet = temp_from_outlet[1].replace(')','');
			// const from_outlet_name = temp_from_outlet[0];
			// const temp_to_outlet = $('#toOutlet').val().split(' (');
			// const to_outlet = temp_to_outlet[1].replace(')','');
			// const to_outlet_name = temp_to_outlet[0];
			...
			// if($('#fromOutlet').val().trim() == ''){
			// 	errorrMessages.push('From Warehouse belum dipilih, Silahkan pilih terlebih dahulu. \n');
			// }
			// if($('#toOutlet').val().trim() == ''){
			// 	errorrMessages.push('To Warehouse belum dipilih, Silahkan pilih terlebih dahulu. \n');
			// }
			if(remark.trim() == ''){
			...
			setTimeout(() => {
				$.post("<?php echo site_url('transaksi1/sentulentry/addData')?>", {
					plant: plant, storageLoc: storage_location, appr: approve, stts: status, postingDate: posting_date, type:type_doc, reason:reason, fromOutlet:from_outlet, fromOutletName:'', toOutlet:'', toOutletName:'', remark:remark, detMatrialNo: matrialNo, detMatrialDesc: matrialDesc, detQty: qty, detUom: uom
				}, function(){
					$('#load').hide();
				})
				.done(function() {
