                ...
                <?php endif; ?>
                    <div class="card">
                        <div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-search4 mr-2"></i>Search of Sentul Entry</legend>  
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-list mr-2"></i>List of Sentul Entry</legend>
                            <a href="<?php echo site_url('transaksi1/sentulentry/add') ?>" class="btn btn-primary"> Add New</a>
        ...
        <script>
                ...
                $("#deleteRecord").click(function(){
                    ...
                    if(deleteidArr.length > 0){
                        ...
                        if(confirmDelete == true){
                            $.ajax({
                                url:"<?php echo site_url('transaksi1/sentulentry/deleteData');?>", //masukan url untuk delete
                                type: "post",
            ...
            function showListData(){
                ...
                dataTable = $('#tableWhole').DataTable({
                    ...
                    "ajax": {
                        "url":"<?php echo site_url('transaksi1/sentulentry/showListData');?>",
                        "type":"POST",
                        "data":{fDate: fromDate, tDate: toDate, stts: status}
                    },
                    "columns": [
                        {"data":"id_sentul_entry_header", "className":"dt-center", render:function(data, type, row, meta){
                            rr=`<input type="checkbox" class="check_delete" id="chk_${data}" value="${data}" onclick="checkcheckbox();">`;
                            return rr;
                        }},
                        {"data":"id_sentul_entry_header", "className":"dt-center", render:function(data, type, row, meta){
                            rr = `<div style="width:100px">
                                        <a href='<?php echo site_url('transaksi1/sentulentry/edit/')?>${data}' ><i class='icon-file-plus2' title="Edit"></i></a>&nbsp;
                                    </div>`;
                            return rr;
                            //<a href='<?php echo site_url('transaksi1/sentulentry/printpdf/')?>${data}' target='_blank'><i class='icon-printer' title="Print"></i></a>&nbsp;
                        }},
