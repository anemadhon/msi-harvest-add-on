		...
		<script>
			...
			function addDatadb(id_approve = ''){
				...
				table.find('tr').each(function(i, el){
					...
					matrialDesc.push(td.eq(3).find('select option:selected').text());
				...
				if(!validasiQty){
					errorMessages.push('Material Number '+dataValidasi.join()+' Quatity Tidak boleh Lebih Besar dari OnHand. \n');
				}
