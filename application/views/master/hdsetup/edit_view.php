                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        <legend class="font-weight-semibold"><i class="icon-reading mr-2"></i>Edit Data Departemen</legend>
                                            ...
                                            <div class="col-lg-9">
                                                <select class="form-control form-control-select2" name="dept_head" id="deptHead" required>
                                                    ...
                                                    <?php foreach($users as $value){?>
                                                        <option value="<?=$value['admin_id']?>" desc="<?=$value['admin_realname']?>" <?=$value['admin_id'] == $divisi['dept_head_id'] ? 'selected' : ''?>><?=$value['admin_username'].' - '.$value['admin_realname']?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-primary" id="update">Update<i class="icon-paperplane ml-2"></i></button>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
