...
class Sentulentry_out extends CI_Controller {
    ...
    public function index(){
        $this->load->view('transaksi1/eksternal/sentulentry_out/list_view');
    }
    ...
    public function showListData(){
        ...
        $rs = $this->se_model->getSentulEntryHeaderOut($date_from2, $date_to2, $status);
        $data = array();
    ...
    public function add(){
        ...
        $object['reasons'] = $this->se_model->getReasons('Out');

        $this->load->view('transaksi1/eksternal/sentulentry_out/add_view', $object);
    }
    ...
    public function edit(){
        ...
        $this->load->view('transaksi1/eksternal/sentulentry_out/edit_view', $object);
    }
